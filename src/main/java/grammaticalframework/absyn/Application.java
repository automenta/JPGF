...
public class Application implements AbsynTree {
    ...
    static public AbsynTree make(AbsynTree function, List<AbsynTree> args) {
        if (args.size() == 0)
            return function;
        AbsynTree f2 = make(function, args.subList(0, args.size() - 1));
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof grammaticalframework.absyn.Application) {
            grammaticalframework.absyn.Application x = (grammaticalframework.absyn.Application) o;
