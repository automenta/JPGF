...
//    }
//
//    protected static int makeInt16(byte[] b) {
//        int i = 0;
//        i |= b[0] & 0xFF;
//        i <<= 8;
//        i |= b[1] & 0xFF;
...
//    }
//
//    protected static void getString(BufferedInputStream is) throws IOException {
//        int npoz = is.read();
//        char ch;
...
//        byte[] i1 = new byte[2];
//        is.read(i1, 0, 2);
//        System.out.println(String.valueOf(makeInt16(i1)));
//    }
//
//    protected static int getInteger(BufferedInputStream is) throws IOException {
//        int rez = is.read();
//        int ii = 0;
//        if (rez <= 0x7f) ;
//        else {
...
//    }
//
//    protected static void getListExpr(BufferedInputStream is) throws IOException {
//        int npoz = is.read();
//        if (npoz == 0) {
//            System.out.println("No expressions");
//            return;
//        } else {
//            System.out.println("Not implemented for more expressions !");
//            throw new IOException();
//        }
//    }
//
//
//    protected static void getListEq(BufferedInputStream is) throws IOException {
//        int npoz = is.read();
//        if (npoz == 0) {
...
//            return;
//        } else {
//            System.out.println("Number of elements : " + npoz);
//            for (int i = 0; i < npoz; i++)
//                getAbsCat(is);
//        }
//
