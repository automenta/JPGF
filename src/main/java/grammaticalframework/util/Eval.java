//package grammaticalframework.util;/* Eval.java
...
//
//    public Eval(String pgf_file, String lang_name) throws IOException, Linearizer.LinearizerException, ParseError, UnknownLanguageException {
//
...
//        }
//
//        new Eval(splits[0], splits[1]);
//    }
//
//    static void translate(PGF pgf, String language)
//            throws UnknownLanguageException, Linearizer.LinearizerException, ParseError {
//        // init stats
//        int success = 0;
//        int error = 0;
//
...
//                List<Tree> trees = ps.getTrees();
//                String translation;
//                if (trees.size() > 0)
//                    try {
//                        translation = mLinearizer.linearizeString(trees.get(0));
//                        success++;
